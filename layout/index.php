...
<body>
	<div id="content">
		...
		<?php
			...
			echo '<ul id="menu">';
				foreach($menu as $key => $value){
					echo '<li class="parent"><a href="#">' . $key . '</a>';
						echo '<ul class="child">';
							foreach($value as $mmenu){
								echo '<li><a href="#">' . $mmenu . '</a></li>';
							}
						echo '</ul>';
					echo '</li>';
				}
		...
		<div id="footer">
				<p>Copyright <?= date('Y');?> &copy; <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>
		</div>
	</div>
</body>
</html>